const ru = {
  ...
  cars: {
    ...
    carCard: {
      ...
      inStock: 'В наличии',
      marketTitle: 'Ориентир — средняя цена на рынке Украины',
      marketLabel: 'Рынок Украины',
      savingsPrefix: 'Экономия',
      savingsSuffix: 'к среднему рынку Украины',
      marketNote: 'Средняя по рынку Украины: {{price}}',
      mileageUnit: 'км',
    },
    carDetail: {
